...
class GenerateAnalysisReportHtmlTests(unittest.TestCase):
    def test_renders_summary_average_cost_reconciliation_and_sales_tops(self) -> None:
        ...
        self.assertIn("매출 품목별 TOP", html)
        self.assertIn("원청별 매출/원가/마진", html)
        ...
        self.assertIn("2026-04-27 ~ 05-03", html)
        self.assertIn("814,000", html)
        self.assertIn("2026-05-04 ~ 05-10", html)
        self.assertIn("462,000", html)

        self.assertIn("Motor Driver IC", html)
        self.assertIn("352,000", html)
        self.assertIn("Sensor Board", html)
